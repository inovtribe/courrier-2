...
@section('content')
    ...
    <div class="container">
        <div class="col">
            <h3>Tous les courriers interne</h3>
            <div class="row">
              <div class="col" style="padding-top: 20px;">
                <a href="{{ route('add_internal_mail') }}" class="btn btn-md btn-primary">Nouveau courier interne</a> 
              </div>
            </div>
                          ...
                          <td> 
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu">
                                <a href="/courrier/single/{{ $item->id }}/internal" class="dropdown-item">
                                  Consulter
                                </a>
