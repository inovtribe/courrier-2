              ...
              <h5 class="pb-20">Informations du Courrier</h5>
                <div class="form-group">
                  ...
                  <div class="custom-file">
                    <input type="file" name="attachment" id="attachment" class="custom-file-input" multiple onchange="javascript:updateList()">
                ...
                <div class="input-group mb-3">
                  ...
                  <select name="expeditor" class="form-control" id="expediteur">
                    ...
                    @foreach ($expeditors_personal as $item)
                      <option value="{{ $item }}">{{ $item->first_name }} {{ $item->last_name }} </option>
                    @endforeach
                    @foreach ($expeditors_company as $item)
                      <option value="{{ $item }}">{{ $item->company_name }} </option>
                    @endforeach
                  </select>
                </div>
          ...
          <div class="row">
            <div class="offset-md-3 col-6">
                ...
                <div class="row" style="padding: 50px 0 30px 0px">
                  <div class="col"  align="">
                    <a href="{{ route('all_mails') }}" class="btn btn-danger">Annuler</a> &nbsp; &nbsp;
                    <a href="#"" class="btn btn-secondary">Passer</a> &nbsp; &nbsp;
                    <button type="submit" class="btn btn-primary">Suivant</button>
                    {{-- <a href="{{ route('mail_form_next') }}" class="btn btn-danger">Annuler</a> &nbsp; &nbsp; --}}
                  </div>
                </div>
              </div>
            </div>
